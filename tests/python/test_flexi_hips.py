...
class DynamicsTestCase(unittest.TestCase):
    def setUp(self):
        ...
        settings = dict(left_stiffness = H_stiff[:2],
    ...
    def test_zero_torque(self):
        ...
        (corrected_q, 
        corrected_dq) = self.flex.correctEstimatedDeflections(desired_torques, 
                                                              self.encoders_q, 
                                                              self.encoders_dq)
        ...
        (corrected_q, 
        corrected_dq) = self.flex.correctDeflections(left_flexing_torque,
    ...
    def test_persistent_toque(self):
        ...
        (corrected_q, 
        corrected_dq0) = self.flex.correctDeflections(left_flexing_torque,
                                                     right_flexing_torque,
        ...
        for i in range(10):
            (corrected_q, 
            corrected_dq10) = self.flex.correctDeflections(left_flexing_torque,
                                                         right_flexing_torque,
                                                         self.encoders_q.copy(), 
                                                         self.encoders_dq.copy())
        ...
        for i in range(1000):
            (corrected_q, 
            corrected_dq1000) = self.flex.correctDeflections(left_flexing_torque,
                                                             right_flexing_torque,
                                                             self.encoders_q.copy(), 
                                                             self.encoders_dq.copy())
        ...
        (corrected_q, 
        corrected_dq1001) = self.flex.correctDeflections(left_flexing_torque,
                                                     right_flexing_torque,
                                                     self.encoders_q.copy(), 
                                                     self.encoders_dq.copy())
    ...
    def test_reset(self):
        ...
        corrected_dq0) = self.flex.correctDeflections(left_flexing_torque,
                                                     ...
                                                     self.encoders_dq.copy())
        (corrected_q1, 
        corrected_dq1) = self.flex.correctDeflections(left_flexing_torque,
                                                     right_flexing_torque,
                                                     self.encoders_q.copy(), 
                                                     self.encoders_dq.copy())
        ...
        self.flex.reset()
        (corrected_q3, 
        corrected_dq3) = self.flex.correctDeflections(left_flexing_torque,
                                                     right_flexing_torque,
                                                     self.encoders_q.copy(), 
                                                     self.encoders_dq.copy())
